    ...
    const body = {
      ...
      requestedShipment: {
        ...
        customsClearanceDetail: {
          ...
          customsValue: { currency: 'USD', amount: req.declaredValueUsd.toFixed(2) },
          commodities: [{
            ...
            quantity: totalQty,
            quantityUnits: 'PCS',
            unitPrice: { currency: 'USD', amount: req.declaredValueUsd.toFixed(2) },
            customsValue: { currency: 'USD', amount: req.declaredValueUsd.toFixed(2) },
            weight: { units: 'KG', value: req.weightKg },
          }],
        },
        requestedPackageLineItems: [{
          ...
          weight: { units: 'KG', value: req.weightKg },
          ...(req.lengthCm && { dimensions: { length: req.lengthCm, width: req.widthCm || 10, height: req.heightCm || 10, units: 'CM' } }),
          declaredValue: { currency: 'USD', amount: req.declaredValueUsd.toFixed(2) },
        }],
      },
    };
